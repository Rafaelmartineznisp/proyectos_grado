...
if(isset($_POST["delete"])){
	...
	if(!is_numeric($id_Autor)){
		header("location:ReadAutor.php");
	}
	else {
		$model= new Crud;
		$test= $model ->deleteFrom="autor";
...
<?php if (isset($_GET["id_Autor"])):?>
	<strong>Realmente quieres eliminar este proyecto: <?php echo htmlspecialchars($_GET["id_Autor"]); ?></strong>
<form class="input" method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
<input type="hidden" name="id_Autor" value="<?php echo htmlspecialchars($_GET['id_Autor']); ?>">
