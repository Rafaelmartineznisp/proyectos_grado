...
$pagination->rowCount("SELECT * FROM autor WHERE id_pro LIKE '%$search%' OR Nombre LIKE '%$search%' OR Apellido LIKE '%$search%' OR id_pro LIKE '%$search%'");
$pagination->config(3, 5);
$sql = "SELECT * FROM autor WHERE id_pro LIKE '%$search%' OR Nombre LIKE '%$search%' OR Apellido LIKE '%$search%' OR id_Autor LIKE '%$search%'  ORDER BY id_Autor ASC LIMIT $pagination->start_row, $pagination->max_rows";
...
{
$pagination->rowCount("SELECT * FROM autor");
$pagination->config(3, 5);
$sql = "SELECT * FROM autor ORDER BY id_Autor ASC LIMIT $pagination->start_row, $pagination->max_rows";
$query = $connection->prepare($sql);
$query->execute();
$model = array();
while($rows = $query->fetch())
...
<style type="text/css">
  ...
  <div class="container-fluid">
    ...
    <ul class="dropdown-menu">
    <li><a href="BuscarLinea.php">Linea de investigacion</a></li>
...
<table class="table table-bordered" >
    ...
    foreach($model as $row)
    {
        ...
        echo "<td><a href='deleteAutor.php?id_Autor=".$row['id_Autor']."'>Eliminar</a></td>";
        echo "</tr>";
    }
    ?>
</table>
