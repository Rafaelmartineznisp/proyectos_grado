...
<input type="text" name="search" placeholder="Buscar Linea de investigacion a eliminar" class="form-control" value="<?php echo $search ?>">
...
<table class="table table-bordered" >
    ...
    foreach($model as $row)
    {
        ...
        echo "<td><a href='deleteLinea.php?id_inv=".$row['id_inv']."'>Eliminar</a></td>";
        echo "</tr>";
    }
    ?>
</table>
