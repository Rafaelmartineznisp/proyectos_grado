<?php
//registra Usuarios Directamente
...
if($filas){
    ...
    $model->insertValues="'$Tipo','$NumeroDocumento','$Nombre', '$Apellido', '$Sexo', $Id_pro";
    $model->create();
  ...
  <table>
   <tr>
    ...
    <tr>
         ...
         <tr>
          <center><h5>---Seleccione un Proyecto---</h5></center>
...
<input type="hidden" name="id_Autor" value="<?php echo $inp; ?>"> 
