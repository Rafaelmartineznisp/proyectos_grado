...
<tr>
	...
	<?php
		...
		foreach ($filas as $fila) {
			...
			echo "<td><a href='UpdateLinea.php?id_inv=".$fila['id_inv']."'>Actualizar</a></td>";
			echo "<td><a href='DeleteLinea.php?id_inv=".$fila['id_inv']."'>Eliminar</a></td>";
						echo "<td><a href='Create1.php?id_inv=".$fila['id_inv']."'>Agregar Proyecto</a></td>";
			echo "</tr>";
		}
